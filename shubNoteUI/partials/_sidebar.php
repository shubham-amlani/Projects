<div class="top-nav d-flex justify-content-center fixed-top align-items-center flex-column">
...
<nav class="sidebar-c d-flex align-items-start flex-column justify-content-evenly gap-5 px-4" id="sidebar-c">
    ...
    <ul class="nav flex-column gap-2">
        ...
        <li class="nav-item">
            <a class="nav-link" href="myaccount.php"><i class="fas fa-user"></i> Profile</a>
        </li>
    </ul>
